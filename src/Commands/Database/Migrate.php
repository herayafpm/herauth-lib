...
namespace Raydragneel\HerauthLib\Commands\Database;

use CodeIgniter\CLI\BaseCommand;
use CodeIgniter\CLI\CLI;
use Config\Services;
use Raydragneel\HerauthLib\Config\Migrations;
use Throwable;
...
class Migrate extends BaseCommand
{
	 ...
	 * @var string
	 */
	protected $group = 'HerauthLib:Database';
	 ...
	 * @var string
	 */
	protected $name = 'herauth:migrate';
	 ...
	 * @var string
	 */
	protected $usage = 'herauth:migrate [options]';
	...
	public function run(array $params)
	{
		...
		$runner = Services::migrations($config);
		$runner->clearCliMessages();

		CLI::write(lang('Migrations.latest'), 'yellow');

		$namespace = 'Raydragneel\HerauthLib';
