...
class MigrateRefresh extends BaseCommand
{
	 ...
	 * @var string
	 */
	protected $name = 'herauth:migrate-refresh';
	 ...
	 * @var string
	 */
	protected $usage = 'herauth:migrate-refresh [options]';
	...
	public function run(array $params)
	{
		...
		$this->call('herauth:migrate-rollback', $params);
		$this->call('herauth:migrate', $params);
	}
}